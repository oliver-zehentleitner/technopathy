...
#### BINANCE REST API — Isolated Margin OCO Order

#### Automate your Binance trading strategy by creating OCO sell orders with Python in isolated margin accounts.

![](https://cdn-images-1.medium.com/max/800/1*d6JGTvdBRWPfOyU9LIoUbw.png)
...
![](https://cdn-images-1.medium.com/max/800/1*FY0jJJKjPXQToMQZzugZdw.png)
