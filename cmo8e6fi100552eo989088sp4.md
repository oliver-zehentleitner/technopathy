...
1.  [Creating the Apache Kafka test environment](#1-creating-the-apache-kafka-test-environment)
    
2.  [Receive data from Binance and throw it into the Kafka Cluster](#2-receive-data-from-binance-and-throw-it-into-the-kafka-cluster)
    
3.  [Read the data from the Kafka cluster](#3-read-the-data-from-the-kafka-cluster)
